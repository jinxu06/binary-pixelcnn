...
class DistortedSinusoid(object):
    ...
    def __init__(self, sinusoid_generator, noise_generator, dataset_name="sinusoid"):
    ...
    def sample(self, num):
        ...
        samples = []
        for i in range(num):
            samples.append(DistortedSineWave(samples_sinusoid, samples_noise, self.input_range))
        return samples
...
class DistortedSineWave(object):
    ...
    """
    def __init__(self, samples_sinusoid, samples_noise, input_range):
