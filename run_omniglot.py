...
train_data, _ = omniglot.sample_mini_dataset(num_classes=1200 * 4, num_shots=100, test_shots=0)
for k in range(5):
    d = 1 - next(train_data)[0][:, :, :, None]
    visualize_samples(d, name="results/omniglot_{0}.png".format(k+1), layout=[10, 10])
quit()
